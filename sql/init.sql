...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`hot` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `permission`(`id`,`permission_name`,`permission_sign`,`description`) values (2,'用户更新','user:update',NULL);
insert  into `permission`(`id`,`permission_name`,`permission_sign`,`description`) values (3,'用户删除','user:delete',NULL);
insert  into `permission`(`id`,`permission_name`,`permission_sign`,`description`) values (4,'用户查询','user:select',NULL);
...
insert  into `role`(`id`,`role_name`,`role_sign`,`description`) values (2,'user','user','普通用户');
